...
// import Comments from '../../../shared/components/Comments/Comments' // Файл Comments.jsx відсутній, тому імпорт закоментовано
import { useAuth } from '../../../../context/AuthContext'
import rootstyle from '../../../../styles/shared/layout/root.module.css'
							...
							<div className=' '>
								...
								<div className='flex my-4'>
									...
									<p className='mr-4 text-gray-400 text-sm'>
										{formatDate(OneNews.publish_date)}
									</p>
									<div className='flex'>
